...
router_1_nodes.each { |n|
  create(:link, tag: router_1_tag, node: n, position: 1)
}
router_1_nodes
...
router_2_nodes.each { |n|
  create(:link, tag: router_2_tag, node: n, position: 1)
}
router_2_nodes
...
nodes_in_ap_network.each { |node|
  create(:link, tag: ap_tag, node: node, position: 5)
}
...
router_3_nodes.each { |n|
  create(:link, tag: router_3_tag, node: n, position: 1)
}
router_3_nodes
...
router_4_nodes.each { |n|
  create(:link, tag: router_4_tag, node: n, position: 1)
}
router_4_nodes
...
nodes_in_internal_network.each { |n|
  create(:link,
    tag: internal_network_tag, node: n, position: 6
  )
}
